    ...
    def capturingFunction(self):
        ...
        if lines is not None:
            ...
            if int(self.image.shape[0] / 2) - 5 <= avgY <= int(self.image.shape[0] / 2) + 5:
                return True, False, False, False, avgY #F L R E AvgY
            if int(self.image.shape[0] / 2) - 5 > avgY:
                return False, False, True, False, avgY #F L R E AvgY
            if avgY > int(self.image.shape[0] / 2) + 5:
                return False, True, False, False, avgY #F L R E AvgY
        else:
            return  False, False, False, True, -1 #F L R E AvgY
